...
-ver "$repo/fpga/rtl/programmer_spi.v"
...
"@ | Set-Content -Encoding ASCII build.synproj
    ...
    Invoke-Checked 'map.exe' @('-a','MachXO2','-p','LCMXO2-1200HC','-t','TQFP100','-s','4','-oc','Commercial','RomEmu_programmer.ngd','-o','RomEmu_programmer_map.ncd','-pr','RomEmu_programmer.prf','-mp','RomEmu_programmer.mrp','-lpf',"$repo/fpga/constraints/spi_bringup.lpf",'-c','0')
