...
а не измерение стенда или результат post-route анализа. Аппаратная проверка
пройдена: игра загружается и работает стабильно — **PASS**
([журнал](../../../docs/TEST_PLAN.md#журнал-результатов)). [Сборка и отчёты](../../../releases/fpga/game_rom/).
